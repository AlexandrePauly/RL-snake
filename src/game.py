...
class SnakeGameAI:
    ...
    def _update_ui(self):
        ...
        record = font.render("Record: " + str(self.record), True, WHITE)
        
        # Positionner le score et le record à des endroits différents
        self.display.blit(score, [10, 10])  # Score en haut à gauche
        self.display.blit(record, [10, 40])  # Record un peu plus bas
    ...
    def _move(self, action):
        ...
        (self.direction == Direction.DOWN and new_dir == Direction.UP):
            new_dir = self.direction  # No change if opposite direction
